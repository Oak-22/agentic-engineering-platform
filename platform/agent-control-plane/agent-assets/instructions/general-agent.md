...
Use this instruction file as portable guidance for AI-assisted work across
repositories.
...
- Do not expose secrets, credentials, tokens, private paths, or personal data
  in generated artifacts.
- Keep reusable guidance separate from repository-specific constraints.

## Review Stance

When asked for review, prioritize behavioral regressions, contract mismatches,
missing tests, stale docs, and boundary violations.
