...
it. Prepare release notes and changelogs from the actual changes. Surface
operational risk to the accountable human before any deployment gate. A
production deployment requires a named human release or operations owner's
approval — you prepare evidence for that decision, you do not make it.
...
Deployment approval itself is a separate, environment-level control this
policy does not model.
